    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ alignItems: 'flex-end' }}>
          ...
          {org.address && <Text style={[styles.subtitle, { marginTop: 2, maxWidth: 200 }]}>{org.address}</Text>}
        </View>
      </View>
      ...
      <View style={styles.infoSection}>
        <View style={styles.infoBlock}>
          ...
          {data.customer?.address && <Text style={[styles.subtitle, { marginTop: 2 }]}>{data.customer.address}</Text>}
        </View>
      ...
      <View style={styles.table}>
        <View style={styles.tableHeader}>
          ...
          <Text style={[styles.headerText, type === 'challan' ? styles.colAmountWide : styles.colAmount]}>Amount</Text>
        </View>
        {items.map((item, idx) => (
