...
export const metadata = {
  ...
  description: 'Looking for a Clover alternative? DineOpen offers AI voice ordering, works on any device (no Clover hardware needed), zero transaction fees. Free 7-day trial.',
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, switching from Clover to DineOpen is easy with our guided migration. Start a free 7-day trial to test all features before fully committing."
      }
    },
    {
      "@type": "Question",
