...
export const metadata = {
  title: 'Free Restaurant Billing Software | 30-Day Free Trial | DineOpen',
  description: 'Get free restaurant billing software with GST support, AI ordering, cloud POS, inventory management & more. Start your 30-day free trial today — no credit card required. Plans from ₹300/month after trial.',
  ...
  openGraph: {
    title: 'Free Restaurant Billing Software | 30-Day Free Trial | DineOpen',
    description: 'Start billing your restaurant for free. Cloud POS, AI ordering, GST billing, inventory & more included in 30-day free trial. No credit card required.',
  ...
  twitter: {
    ...
    description: 'Start billing your restaurant for free. Cloud POS, AI ordering, GST billing, inventory & more included in 30-day free trial.',
  },
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, you can use DineOpen billing software completely free for 30 days. After the trial, plans start at just ₹300/month for Indian restaurants or $9.99/month for international restaurants. There are no per-transaction fees, no hidden charges, and no long-term contracts required."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, DineOpen's free trial includes full GST compliance. You can generate GST-compliant invoices, automatically calculate CGST and SGST, manage HSN codes, and export tax reports for filing — all included at no cost during the 30-day trial period."
        }
      },
      {
        "@type": "Question",
