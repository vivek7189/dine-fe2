import TablesLandingClient from '../tables/TablesLandingClient';
...
export const metadata = {
  ...
  keywords: 'restaurant table management, table management system, restaurant table booking software, floor plan management, table tracking software, restaurant reservation app',
  openGraph: {
    title: 'Table Management & Reservation System | DineOpen Tables',
    description: 'Manage restaurant tables, floors, and reservations. Real-time availability tracking and visual floor plans.',
    url: 'https://www.dineopen.com/products/table-management',
    siteName: 'DineOpen',
    type: 'website',
  },
  twitter: {
...
export default function TableManagementPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Table Management", "item": "https://www.dineopen.com/products/tables" }
    ]
  };
