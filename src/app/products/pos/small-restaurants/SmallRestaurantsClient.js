...
export default function SmallRestaurantsClient() {
  ...
  const whySmall = [
    { icon: <FaRupeeSign size={28} />, title: 'Starts at $9.99/mo', description: 'The Spark plan gives you a complete POS for just $9.99/mo ($89/mo for Blaze). In India, that is ₹300/mo and ₹2,500/mo respectively. Zero transaction fees means you keep every rupee.' },
  ...
  const perfectFor = [
    ...
    { title: 'New Restaurant Openings', desc: 'Get operational immediately without a large upfront investment. Start with Spark and upgrade to Blaze as your business grows. All data migrates seamlessly.' },
  ...
  const comparisonPoints = [
    { label: 'Monthly cost', dineopen: 'From $9.99/mo', others: '$50-200/mo typical' },
  ...
  const faqs = [
    { q: 'How much does DineOpen POS cost for small restaurants?', a: 'The Spark plan is $9.99/mo (₹300/mo in India). It includes full POS with all order types, multi-payment support, receipt printing, and tax calculations. Zero transaction fees on all plans.' },
    ...
    { q: 'Can I upgrade later as my restaurant grows?', a: 'Yes. Start with Spark at $9.99/mo and upgrade to Blaze at $89/mo when you need multi-location support and real-time updates. All your data carries over automatically.' },
        ...
        <section style={{ background: 'linear-gradient(135deg, #fef2f2 0%, #ffffff 50%, #fef2f2 100%)', padding: isMobile ? '60px 20px' : '100px 40px', textAlign: 'center' }}>
          <div style={{ maxWidth: '850px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: isMobile ? '18px' : '20px', color: '#374151', lineHeight: 1.7, maxWidth: '700px', margin: '0 auto 40px' }}>
              A full-featured POS system that does not require expensive hardware, long contracts, or a big monthly bill. Start at $9.99/mo with zero transaction fees. Use your existing phone or tablet.
            </p>
        ...
        <section style={{ backgroundColor: 'white', padding: isMobile ? '60px 20px' : '80px 40px' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '18px', color: '#374151', lineHeight: 1.7, marginBottom: '32px' }}>
              Begin with the Spark plan at $9.99/mo. When you open a second location or need advanced features, upgrade to Blaze at $89/mo. All your menu items, order history, and settings carry over automatically.
            </p>
            <div style={{ display: 'inline-block', background: '#f9fafb', padding: '32px', borderRadius: '16px', border: '1px solid #e5e7eb', marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: '4px', marginBottom: '8px' }}>
                <span style={{ fontSize: '48px', fontWeight: '800', color: '#111827' }}>$9.99</span>
                <span style={{ fontSize: '18px', color: '#6b7280' }}>/mo</span>
              </div>
              <p style={{ fontSize: '16px', color: '#6b7280', marginBottom: '4px' }}>₹300/mo in India</p>
