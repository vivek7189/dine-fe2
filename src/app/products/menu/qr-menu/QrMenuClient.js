...
export default function QrMenuClient() {
  ...
  const faqs = [
    ...
    { q: 'How much does a QR code menu cost?', a: 'QR menu generation is included in all DineOpen plans. The Spark Plan starts at $9.99/month (Rs 300/month in India) and includes unlimited QR codes, unlimited menu items, and zero transaction fees. No per-scan charges.' },
