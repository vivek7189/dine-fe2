...
export default function ThemesClient() {
  ...
  const faqs = [
    ...
    { q: 'Do themes cost extra?', a: 'No. All 6 themes are included in every DineOpen plan. The Starter Plan at $20/month (₹299/month India) and Pro Plan at $99/month (₹1,799/month India) both include all themes, 3D preview, and device-specific previews.' },
