  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, DineOpen offers a 30-day free trial for all Bangalore restaurants and cloud kitchens. No credit card required. Get full access to GST billing, Swiggy/Zomato integration, and real-time analytics."
        }
      }
    ]
  };
