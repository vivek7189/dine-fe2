...
export const getBillPrintCSS = (scaleOrPreset, fontId) => {
  ...
  return `@page{size:80mm auto;margin:0;}body{font-family:${ff};margin:2mm 3mm;font-size:${f.body};line-height:${f.lineHeight};width:100%;max-width:80mm;box-sizing:border-box;overflow:hidden;} .bill-header{text-align:center;margin-bottom:8px;} .restaurant-name{font-size:${f.restaurantName};font-weight:bold;text-transform:uppercase;word-wrap:break-word;overflow-wrap:break-word;} .bill-title{font-size:${f.billTitle};font-weight:bold;margin-top:4px;} .bill-logo{max-width:100%;height:auto;display:block;} .divider{text-align:center;margin:6px 0;overflow:hidden;} .bill-info{margin:8px 0;font-size:${f.info};} .bill-info div{display:flex;justify-content:space-between;margin:3px 0;} .bill-info div span:last-child{text-align:right;flex-shrink:0;} .info-row{display:flex;justify-content:space-between;margin:2px 0;} table{width:100%;border-collapse:collapse;margin:8px 0;table-layout:fixed;} th{text-align:left;border-bottom:1px dashed #000;padding:4px;font-size:${f.th};} td{font-size:${f.td};padding:${f.tdPadding};word-wrap:break-word;overflow-wrap:break-word;overflow:hidden;} .total-section{border-top:1px dashed #000;margin-top:8px;padding-top:4px;font-size:${f.totalSection};} .total-section div[style*="flex"]{flex-wrap:nowrap;} .total-section div[style*="flex"] span:last-child{flex-shrink:0;white-space:nowrap;} .total-row{display:flex;justify-content:space-between;font-weight:bold;font-size:${f.totalRow};margin-top:4px;} .total-row span:last-child{flex-shrink:0;white-space:nowrap;} .bill-footer{margin-top:12px;text-align:center;font-size:${f.footer};}`;
};
