...
body{font-family:${ff};font-size:${f.body};line-height:${f.lineHeight};${combined ? 'background:#f3f4f6;padding:16px;' : 'width:72mm;padding:6px 8px;'}}
.token-slip{width:${combined ? '72mm' : '100%'};background:white;color:black;${combined ? 'padding:8px 12px;margin:0 auto 16px;box-shadow:0 8px 24px rgba(15,23,42,0.12);page-break-after:always;break-after:page;' : ''}}
