...
const KEYWORD_MAP = [
  ...
  [['dal chawal', 'dal rice', 'dal khichdi'], 'dal-chawal.jpg'],
  [['chana dal', 'chana daal'], 'chana-dal.jpeg'],
  [['kadhai paneer', 'kadai paneer', 'karahi'], 'kadhai.jpeg'],
  [['shahi paneer'], 'shahi-paneer.jpeg'],
  [['paneer butter masala', 'paneer makhani'], 'butter-paneer.jpg'],
  [['methi malai', 'methi paneer', 'methi matar'], 'palak-paneer.jpeg'],
  ...
  [['stuffed capsicum', 'bharwa shimla mirch'], 'stuffed-capsicum.jpg'],
  [['baby corn'], 'corn.jpeg'],
  [['thali'], 'thali.jpeg'],
  ...
  [['sambar vada', 'sambhar vada'], 'vada.jpeg'],
  [['medu vada'], 'vada.jpeg'],
  [['curd vada'], 'dahi-vada.jpg'],
  ...
  [['dahi vada', 'dahi bhalla'], 'dahi-vada.jpg'],
  ...
  // === Combos / Platters ===
  [['combo meal', 'combo'], 'combo-meal.jpg'],
  [['non veg platter', 'mixed grill'], 'non-veg-platter.jpg'],
  [['breakfast platter'], 'breakfast-platter.jpg'],
  [['snack platter'], 'snack-platter.jpg'],

  // === Misc ===
  [['potato', 'aloo'], 'potato-dish.jpg'],
];

// Normalize so punctuation in item names doesn't break matching, e.g. "Bailey's" and
// "DH Red Claret (Dry)" should still match "baileys" / "dh red claret dry".
...
const CATEGORY_FALLBACKS = {
  ...
  'roll': 'wrap.jpeg',
  'wrap': 'wrap.jpeg',
  'combo': 'combo-meal.jpg',
  'platter': 'snack-platter.jpg',
  'side': 'raita.jpeg',
};
