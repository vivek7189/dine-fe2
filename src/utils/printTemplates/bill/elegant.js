...
function getElegantBillCSS(scaleOrPreset, fontId, printerWidth, printSettings) {
  ...
  return `@page{size:${cw} auto;margin:0;}*{box-sizing:border-box;}body{font-family:${ff};margin:0;padding:3mm 3mm;font-size:${f.body};line-height:${f.lineHeight};width:${cw};max-width:${cw};overflow-wrap:break-word;word-wrap:break-word;} .bill-header{text-align:center;margin-bottom:6px;} .restaurant-name{font-size:${f.restaurantName};font-weight:bold;text-transform:uppercase;letter-spacing:3px;word-wrap:break-word;overflow-wrap:break-word;} .bill-title{font-size:${f.billTitle};font-weight:bold;margin-top:6px;font-style:italic;} .bill-logo{height:auto;display:block;} .divider{margin:4px 0;border-top:1px solid #000;font-size:0;line-height:0;height:0;overflow:hidden;} .bill-info{margin:4px 0;font-size:${f.info};} .bill-info div{display:flex;justify-content:space-between;flex-wrap:wrap;margin:2px 0;gap:4px;} .bill-info div span:first-child{flex:0 1 auto;min-width:0;} .bill-info div span:last-child{text-align:right;flex:0 1 auto;min-width:0;} table{width:100%;border-collapse:collapse;margin:4px 0;table-layout:fixed;} th{text-align:left;border-bottom:1px solid #000;padding:2px;font-size:${f.th};font-style:italic;} td{font-size:${f.td};padding:3px 2px;word-wrap:break-word;} td:last-child{text-align:right;} .total-section{border-top:1px solid #000;margin-top:4px;padding-top:4px;font-size:${f.totalSection};} .total-section div[style*="flex"]{flex-wrap:nowrap;} .total-row{display:flex;justify-content:space-between;font-weight:bold;font-size:${f.totalRow};margin-top:6px;letter-spacing:1px;} .bill-footer{margin-top:8px;text-align:center;font-size:${f.footer};font-style:italic;}`;
}
