...
export function generateKOTHTML(kotData, printSettings = {}, labels = {}) {
  ...
  const tableOrRoom = k.roomNumber
    ...
    : (k.tableNumber ? `<div><strong>${L.table}:</strong> ${k.tableNumber}</div>` : '');
